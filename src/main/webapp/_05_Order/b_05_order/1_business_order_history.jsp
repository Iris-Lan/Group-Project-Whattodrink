...
<!DOCTYPE html>
    ...
    <div class="container-fluid" style="min-height: 80vh">
      <div class="row p-0">
        <div class="col-sm-10 mx-auto">
          <p class="fs-4 mt-5 fw-bold">歷史訂單</p>
        </div>
      </div>
      <div class="row p-0">
 ...
 >
   ...
   <div class="offcanvas-body lh-base">
    ...
    <!-- Modal -->
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" id="detail">
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="<c:url value="/_05_Order/b_05_order/1_business_order_history3.js"/>"></script>
  </body>
</html>

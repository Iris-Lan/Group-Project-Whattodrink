...
<html>
  ...
  <body>
    ...
    <div class="container-fluid" style="min-height: 80vh">
      <div class="row p-0">
        <div
          class="col-sm-10 mx-auto d-flex flex-direction-row"
          style="justify-content: space-between; align-items: center"
        >
          <p class="fs-4 mt-5 fw-bold">待處理訂單</p>
          <a
            role="button"
            href="<c:url value="/_05_Order/b_05_order/1_business_order_details(all).jsp"/>"
            class="btn btn-sm btn-dark mt-5 mb-3"
   ...
   <!-- footer start -->
    ...
    <!-- Modal -->
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="alter" tabindex="-1">
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">訂單細項</h5>
            <button
              type="button"
              class="btn-close"
  ...
  <!-- hamburger menu -->
    ...
    ></script>
       ...
       <script src="<c:url value="/_05_Order/b_05_order/1_business_orders.js"/>"></script>
  </body>
</html>

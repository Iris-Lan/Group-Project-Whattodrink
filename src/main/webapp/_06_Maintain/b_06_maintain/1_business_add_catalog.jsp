...
<html>
    ...
    <div class="container-fluid" style="min-height: 80vh">
      <div class="row p-0">
        ...
        <div class="col-sm-10 mx-auto d-flex">
          <form class="col-sm-6 mb-2" id="catalog">
            <input
            ...
            <input
              class="form-control my-3 form-control-sm"
              placeholder="系列名稱"
              style="width: 250px"
              type="text"
              id="name2"
  ...
  <!-- hamburger menu -->
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="<c:url value="/_06_Maintain/b_06_maintain/1_business_add_catalog1.js"/>"></script>
  </body>
</html>

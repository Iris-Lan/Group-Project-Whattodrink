...
<link rel="stylesheet"
	href="<c:url value="/_06_Maintain/b_06_maintain/style.css"/>" />
</head>
<body>
	<!-- header start -->
	<nav class="navbar navbar-expand-lg">
		...
		<div class="container-fluid p-0">
			<a class="navbar-link text-dark p-0" data-bs-toggle="offcanvas"
				href="#hamburgerMenu"><i class="fas fa-bars"></i></a> <a
				class="navbar-link d-flex justify-content-center" href="#"><img
				src="<c:url value="/images/logo.png"/>" alt="logo" /></a> <a
				class="nav-link text-dark p-0"
				href="<c:url value="/_02_Login/b_02_login/1_business_login.jsp"/>"><i
	...
	<div class="container-fluid" style="min-height: 80vh">
		<div class="row p-0">
			<div class="col-sm-1"></div>
			<div class="col-sm-5">
				<p class="fs-4 mt-5 fw-bold">新增分類</p>
				<p>請輸入系列分類</p>
			</div>
				...
				<div class="col me-5">
					<form action="https://whattodrink.herokuapp.com/AddCategoryServlet" method="POST">
						<input class="form-control mb-3 form-control-sm"
							...
							id="name1" /> <input
							class="form-control my-3 form-control-sm" placeholder="系列名稱"
							style="width: 250px" type="text" name="name2" id="name2" />
						<input class="form-control my-3 form-control-sm"
							placeholder="系列名稱" style="width: 250px" type="text" name="name3"
							id="name3" /> <input
							class="form-control my-3 form-control-sm" placeholder="系列名稱"
							style="width: 250px" type="text" name="name4" id="name4" />
						<input class="form-control my-3 form-control-sm"
							placeholder="系列名稱" style="width: 250px" type="text" name="name5"
							id="name5" />
				</div>
				<div class="col me-5">
					<input class="form-control mb-3 form-control-sm" placeholder="系列名稱"
						style="width: 250px" type="text" name="name6" id="name6" />

					<input class="form-control my-3 form-control-sm" placeholder="系列名稱"
						style="width: 250px" type="text" name="name7" id="name7" />
					<input class="form-control my-3 form-control-sm" placeholder="系列名稱"
						style="width: 250px" type="text" name="name8" id="name8" />
					<input class="form-control my-3 form-control-sm" placeholder="系列名稱"
						style="width: 250px" type="text" name="name9" id="name9" />
					<input class="form-control my-3 form-control-sm" placeholder="系列名稱"
						style="width: 250px" type="text" name="name10" id="name10" />
	...
	<script
		src="<c:url value="/_06_Maintain/b_06_maintain/1_business_add_catalog1.js"/>"></script>

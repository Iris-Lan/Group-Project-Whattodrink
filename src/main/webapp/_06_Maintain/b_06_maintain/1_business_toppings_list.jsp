 ...
 <link rel="stylesheet" href="<c:url value="/_06_Maintain/b_06_maintain/style.css"/>" />
  ...
  <body>
    ...
    <div class="container-fluid" style="min-height: 80vh">
      <div class="row p-0">
        <div class="col-sm-10 mx-auto">
          <p class="fs-4 mt-5 fw-bold">配料列表</p>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-10 mx-auto">
          ...
          <div class="modal-body">
            ...
            >
              ...
              <div class="modal-footer justify-content-center">
                <input class="d-none" id="toppingId" name="toppingId" />
                <button
                  type="submit"
                  class="btn btn-dark"
                  data-bs-dismiss="modal"
    ...
    <script
      ...
      crossorigin="anonymous"
    ></script>
    <script src="<c:url value="/_06_Maintain/b_06_maintain/1_business_toppings_list.js"/>"></script>
  </body>
</html>

...
<html>
    ...
    <div class="container-fluid" style="min-height: 80vh">
      <div class="row p-0">
        <div class="col-sm-10 mx-auto">
          <p class="fs-4 mt-5 fw-bold">日報表</p>
        </div>
      </div>

      <div class="row">
        <div class="col-sm-10 mx-auto mb-3 fw-bold" id="ordQ">訂單總數</div>
        <div class="col-sm-10 mx-auto mb-3 fw-bold" id="ordT">訂單總額</div>
        <div class="col-sm-10 mx-auto mb-3 fw-bold" id="ordA">平均訂單金額</div>
        <div class="col-sm-10 mx-auto mb-3 fw-bold">各時段銷售單數</div>
        <div class="col-sm-10 mx-auto">
 ...
 <!-- footer start -->
  ...
  <!-- hamburger menu -->
    ...
    <script src="<c:url value="/_07_Others/b_07_other/1_business_report1.js"/>"></script>
  </body>
</html>
